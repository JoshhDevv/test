...
token = 'ODMyMDQ1MTkxNjM2MDU4MTIy.YHeEeA.l15KBDWrCY-6ZzqepqG8H_ytd4U'
prefix = '/'
...
administrators = [831844531899990056]
chat_channel = 831252777258188821
bots_channel = 831275713553629265
queue = []
...
async def on_member_join(member):
    ...
    await channel.send(f'Welcome to **FAMEGG**, {member.mention}.\nType `/help` to get started!')
